...
**نکته: با مراجعه به داشبورد کانال‌های چت آنلاین وب‌سایت، از طریق بردکرامب بالای صفحه، می‌توانید به فرم جزئیات کانال برای هر کانالی دسترسی پیدا کنید. کارت کانال مربوطه را پیدا کرده و نشانگر موس را روی آن نگه دارید، سپس روی نماد ⋮ (سه نقطه) کلیک کنید تا منوی کشویی باز شود. سپس، روی "Configure Channel" کلیک کنید تا فرم جزئیات کانال باز شود**|br|
...
با توجه به تصویر زیر، در فرم جزئیات کانال، روی تب "Operators" کلیک کنید.|br|
