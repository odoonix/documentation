...
- طرح بندی شبکه به شما اجازه می دهد تا با کشیدن و رها کردن عناصر، مانند تصاویر یا متن، آنها را تغییر دهید و اندازه آنها را تغییر دهید.
...
برای پنهان یا نشان دادن بلوک‌های ساختمانی با استفاده از شرایط، ابتدا یک عنصر را انتخاب کنید. سپس به قسمت "Visibility" بروید و روی "No condition" کلیک کنید. سپس به جای آن، "Conditionally" را انتخاب کنید. در این مرحله، با انتخاب "Visible for" یا "Hidden for" و تعیین رکوردهایی که تحت شرایط تاثیر خواهند گرفت، شرایط مورد نظر را پیکربندی کنید.

.. image:: ./img/website11.png
    :alt: وبسایت
    :align: center
...
برای نمایش مجدد یک بلوک ساختمانی که ممکن است پنهان شده باشد، به قسمت "Invisible Elements" در پایین پیکربندی بروید. سپس بلوک ساختمانی مورد نظر را انتخاب کنید تا دوباره قابل مشاهده شود.

.. image:: ./img/website12.png
    :alt: وبسایت
    :align: center
...
برای ذخیره یک بلوک ساختمانی سفارشی شده و استفاده مجدد از آن، ابتدا آن را انتخاب کنید. سپس به تب "Customize" بروید و روی نماد فلاپی دیسک کلیک کنید تا آن را ذخیره کنید.

.. image:: ./img/website13.png
    :alt: وبسایت
    :align: center

بلوک‌های ساختمانی ذخیره شده در بخش "Blocks" در تب "Custom" در دسترس هستند. برای ویرایش نام آنها، بر روی آیکون خودکار قلم کلیک کنید.

.. image:: ./img/website14.png
    :alt: وبسایت
    :align: center

برای مشاهده زیر بخش ها روی لینک های زیر کلیک کنید:
