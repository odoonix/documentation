...
.. example::
    برای مشاهده ارزیابی پس از دریافت از فروشنده، به صفحه ورودی های داده های روزنامه موجود در برنامه حسابداری(صدورفاکتور)‣ حسابداری‣ ورودی های دفترروزنامه بروید. در اینجا، روی خط روزنامه که در آن مقدار ستون مرجع با مرجع روی رسید، WH/IN/00014 مطابقت دارد، کلیک کنید.
    
    .. image:: ./img/inventoryvaluation/v11.jpg
        :align: center
        :alt: انبار

    سهام موقت یک حساب نگهداری برای پولی است که برای پرداخت به فروشندگان برای محصول در نظر گرفته شده است. حساب ارزش گذاری سهام، ارزش تمام سهام موجود را ذخیره می کند.

    .. image:: ./img/inventoryvaluation/v12.jpg
        :align: center
        :alt: انبار
