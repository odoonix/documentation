...
3.	سپس به برنامه Inventory ‣ Configuration ‣ Routes بروید .
4.	برای نمایش مسیرهای بایگانی شده روی Filters ‣ Archived کلیک کنید.
5.	کادر کنار Replenish on Order (MTO) را انتخاب کنید و روی Action ‣ Unarchive کلیک کنید .
