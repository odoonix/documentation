...
گزارش موجودی
---------------------------------------------
فقط محصولات قابل نگهداری در گزارش های زیر ظاهر می شوند.
گزارش سهام فهرستی جامع از تمام محصولات قابل ذخیره، بدون رزرو، ورودی و خروجی است. این گزارش فقط برای کاربرانی که دسترسی سرپرست دارند در دسترس است و با پیمایش به برنامه **انبار ‣ گزارش ‣ موجودی کالا** پیدا می شود


.. image:: ./img/producttracking/t65.jpg
        :align: center
        :alt: انبار 

گزارش موقعیت مکانی به تفکیک هر مکان (داخلی، خارجی یا مجازی) و مقدار موجود و رزرو شده هر محصول قابل ذخیره سازی است. این گزارش فقط با فعال شدن ویژگی مکان ذخیره سازی (برنامه انبار‣ پیکربندی ‣ تنظیمات) و برای کاربرانی که دسترسی مدیر دارند در دسترس است.

با رفتن به برنامه  :menuselection:`انبار --> گزارش --> موجودی کالا` به گزارش موقعیت مکانی بروید.
