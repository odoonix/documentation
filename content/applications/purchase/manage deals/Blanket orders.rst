...
پس از تأیید :abbr:`PO(purchase Order)`، به فرم سفارش عمده (در بالای صفحه) برگردید. از فرم سفارش عمده، اکنون یک :abbr:`OCR (optical character recognition)`در دکمه هوشمند RFQs/Orders در سمت راست بالای فرم فهرست شده است. روی دکمه هوشمند RFQs/Orders کلیک کنید تا PO ایجاد شده را ببینید.
