...
هر شرکت می تواند از فروشنده و رستوران های مختلفی سفارش غذا داشته باشد. بدین صورت که با وارد شدن از قسمت پیکر بندی>> فروشندگان صفحه ایی باز می شود که باشد اطلاعات رستوران مورد نظر را به عنوان فروشنده وارد کرد.
...
-   **دسترسی:**
از این بخش تقویم می توانیم روزهایی که غذای مد نظر در آن رستوران موجود و یا تمایل داریم در یک روز خاص منوی غذا از این فروشنده باشد تیک میزنیم.
