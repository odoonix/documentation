...
1. در قسمت مربوطه، عنوان صفحه خود را وارد کنید؛ این عنوان هم در منوی وب‌سایت و هم در URL صفحه استفاده می‌شود.
2. پس از وارد کردن عنوان، روی دکمه "Create" یا "ایجاد" کلیک کنید.
3. سپس، محتوا و ظاهر صفحه را با استفاده از ابزار سازنده وب‌سایت سفارشی کنید. وقتی کار خود را تکمیل کردید، روی دکمه "Save" یا "ذخیره" کلیک کنید.
4. در نهایت، صفحه خود را منتشر کنید تا به دسترس عموم قرار گیرد.

.. image:: ./img/website27.png
    :alt: وبسایت
    :align: center
...
1. سوئیچ "Activate" را تغییر دهید تا تغییر مسیر فعال شود.
